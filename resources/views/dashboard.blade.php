...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li><a class="nav-link" href="{{ route('occupied-plot') }}"><i class="ti ti-plus"></i><span
                        class="nav-text">
                        Occupied Plot</span></a></li>
            <li><a class="nav-link" href="{{ route('available-plot') }}"><i class="ti ti-receipt"></i><span
                        class="nav-text">Available Plot</span></a>
            </li>
            <li><a class="nav-link" href="{{ route('burial-records') }}"><i class="ti ti-alert-circle"></i><span
                        class="nav-text">Burial Records</span></a>
            </li>
            <li><a class="nav-link" href="{{ route('reports') }}"><i class="ti ti-file-text"></i><span
                        class="nav-text">Reports</span></a></li>
            <li><a class="nav-link" href="{{ route('settings') }}"><i class="ti ti-file-text"></i><span
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h2 class="fw-bold mb-0">{{ $totalPlots }}</h2>
                            </div>
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h2 class="fw-bold mb-0">{{ $occupiedPlots }}</h2>
                            </div>
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h2 class="fw-bold mb-0">{{ $availablePlots }}</h2>
                            </div>
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h2 class="fw-bold mb-0">{{ $monthlyBurials }}</h2>
                            </div>
                            ...
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    @forelse($recentBurials as $burial)
                                        <tr>
                                            <td>
                                                {{ $burial->deceased_first_name }}
                                                {{ $burial->deceased_last_name }}
                                            </td>

                                            <td>{{ $burial->plot->plot_number ?? '-' }}</td>

                                            <td>{{ $burial->plot->section ?? '-' }}</td>

                                            <td>{{ \Carbon\Carbon::parse($burial->burial_date)->format('F d, Y') }}
                                            </td>
